...
void Graphics::Initialize(void)
{
    ...
    else
    {
        ...
        {
            // TODO: This should be enabled if we want consistent timings, but for some reason it doesn't want to work on my local pc anymore.
            // more investigation is needed, as it still works on the RTX machine from DAER
